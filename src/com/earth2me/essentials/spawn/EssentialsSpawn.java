...
public class EssentialsSpawn extends JavaPlugin implements IEssentialsSpawn
{
	...
	public void onEnable()
	{
		...
		pluginManager.registerEvent(PlayerJoinEvent.class, playerListener, EventPriority.LOWEST, new EventExecutor()
		{
			@Override
			public void execute(final Listener ll, final Event event) throws EventException
			{
				((EssentialsSpawnPlayerListener)ll).onPlayerJoinLowest((PlayerJoinEvent)event);
			}
		}, this);
	}
